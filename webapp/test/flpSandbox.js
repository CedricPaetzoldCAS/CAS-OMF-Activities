		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OMF Activities",
									"targetURL": "#decasomfactivities-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"decasomfactivities-display": {
								"semanticObject": "decasomfactivities",
								"action": "display",
								"description": "SAP Fiori App to display OMF order activities",
								"title": "OMF Activities",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=de.cas.omfactivities",
									"url": sap.ui.require.toUrl("de/cas/omfactivities")
								}
							}
						}
					}
